...
//! The scheme values are Horizon's built-in defaults (`ui::theme`
//! chrome defaults + `ui::theme::ansi`'s 16-slot palette) hardcoded
//! for now; config-file theming and `cx.global` land with M3
