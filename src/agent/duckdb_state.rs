...
use crate::{
    agent::{
        agent_event_kind, agent_frame_from_events, AgentEvent, AgentFrame, AgentMessageRole,
        AgentProviderId, AgentToolCallId,
    },
    workspace::SessionId,
};
...
mod tests {
    use super::*;
    use crate::agent::{
        AgentApprovalRequest, AgentMessage, AgentMessageDelta, AgentSessionState,
