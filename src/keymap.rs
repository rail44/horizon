...
pub(crate) fn command_for(id: &str) -> Option<CommandId> {
    match id {
        ...
        "replan-board-milestone" => Some(CommandId::ReplanBoardMilestone),
        "open-board-milestone-session" => Some(CommandId::OpenBoardMilestoneSession),
        "toggle-board-history" => Some(CommandId::ToggleBoardHistory),
        "toggle-board-milestone-filter" => Some(CommandId::ToggleBoardMilestoneFilter),
