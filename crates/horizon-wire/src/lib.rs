...
//! per-purpose channel size caps, version negotiation, the shared hub error
//! vocabulary, the socket-path conventions, the session identifier, and the
//! merge-time schema-change classifier.
//!
